...
const SnowRainyWelcomeScreen = () => {
  ...
  return (
    <View style={styles.mainContainer}>
      <ImageBackground source={require('../../assets/snowbg.jpg')} style={styles.background}>
      <Image source={require('../../assets/raindrops.png')} style={styles.raindrops}></Image>
      <Animated.View style={[movingSun]}>
        <Image style={styles.sun} source={require('../../assets/snowrain.png')}/>
      </Animated.View>
...
export default SnowRainyWelcomeScreen
