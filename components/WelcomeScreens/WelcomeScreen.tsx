...
const WelcomeScreen = () => {
  ...
  const movingSun = useAnimatedStyle(() => ({
    ...
    transform: [{rotate: `${sunRotation.value * 360}deg`}, {scale: sunOpacity.value}]
  }))
  ...
  React.useEffect(() => {
    ...
    sunRotation.value = withRepeat(withTiming(1, {duration:5000, easing:Easing.linear}), 0)
    ...
    thCloud.value = withDelay(800, withTiming(0, {duration:1000, easing:Easing.linear}))
  }, [])
  return (
    <View style={styles.mainContainer}>
      <ImageBackground source={require('../../assets/backgroundBlueSky.jpg')} style={styles.background}>
      ...
      <Animated.View style={[styles.cloudOneWrapper,movingFCloud]}>
        <Image style={[styles.cloud]} source={require('../../assets/cloudThree.png')}/>
      </Animated.View>
      <Animated.View style={[styles.cloudTwoWrapper,movingTwCloud]}>
        <Image style={[styles.cloud]} source={require('../../assets/cloudOne.png')}/>
      </Animated.View>
